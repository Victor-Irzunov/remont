			...
			<div className='container'>
				...
				<div className=''>
					...
					<div className='border-b py-4'>
						...
						<div className='pl-6 mt-2'>
							<p className='text-left text-sm mt-4'>
								Пол года сильно гудел холодильник, я его крутил во все стороны, ничего не помогало. Коллега на работе порекомендовал этих ребят, приехал мастер немного позже чем договаривались, говори пробка на дороге. Возился почти час, но сделал, теперь тихо как раньше. Результатом очень доволен. Рекомендую!
							</p>
					...
					<div className='border-b py-4'>
						...
						<div className='pl-6 mt-2'>
							<p className='text-left text-sm mt-4'>
								Перестал морозить холодильник, нашел в интеренте номер, позвонил, приехали быстро. Заправили фреоном, поменяли уплотнитель двери. Ценой и работой я доволен. Спасибо.
							</p>
